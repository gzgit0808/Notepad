...
namespace 记事本
{
    public partial class frmNotepad : Form
    {
        ...
        private void tlsNotepad_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            {
                case 0:
                    tsmiNew_Click(sender, e);//新建NToolStripButton_Click
                    break;
                case 1:
                    tsmiOpen_Click(sender, e);//打开OToolStripButton_Click
                    break;
                case 2:
                    保存SCtrlSToolStripMenuItem_Click(sender, e);//保存SToolStripButton_Click
                    break;
                /*case 3:
                ...
                case 4:
                    tsmiCut_Click(sender, e);//剪切UToolStripButton_Click
                    break;
                case 5:
                    tsmiPaste_Click(sender, e);//粘贴PToolStripButton_Click
                    break;
                /*case 6:
        ...
        {
            StatusLabel2.Text = System.DateTime.Now.ToString();
        }
    }
}
